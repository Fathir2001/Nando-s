  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 pt-10 pb-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-2xl md:text-3xl font-bold mb-8 text-gray-900">Your Cart</h1>
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <p className="text-gray-900 font-medium">LKR {subtotal.toFixed(2)}</p>
                    </div>
                    <div className="flex justify-between">
                      <p className="text-gray-600">Delivery Fee</p>
                      <p className="text-gray-900 font-medium">LKR {deliveryFee.toFixed(2)}</p>
                    </div>
                    <div className="border-t pt-4 flex justify-between">
                      <p className="text-gray-900 font-bold">Total</p>
                      <p className="text-brightColor font-bold">LKR {total.toFixed(2)}</p>
                    </div>
                  </div>
                  <button 
